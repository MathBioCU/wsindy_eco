...
% rng('shuffle');
seed1 = -4;%'shuffle'; % seed for random generation selection, can just be pre-selected generations
seed2 = 2024;'shuffle';
seed2 = rng().Seed; % seed for random noise
snr_X = 0.000; % noise level for X
snr_Y = 0.05; % noise level for Y
num_train_inds = 2; % number of generations observed / number of gens around each peak
